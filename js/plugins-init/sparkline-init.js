	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){	
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#450b5a",
				fillColor: "rgba(69, 11, 90, .5)",
				minSpotColor: "#450b5a",
				maxSpotColor: "#450b5a",
				highlightLineColor: "#450b5a",
				highlightSpotColor: "#450b5a",
		...
		if(jQuery('#StackedBarChart').length > 0 ){	
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7, 
					stackedBarColor: ['#450b5a', '#209f84', '#ff5c00']
				});
		}
	}
